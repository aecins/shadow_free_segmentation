function labRatioFeat = getLABratioFeatures(im, scales, orientedMasks, edgePixelCrd, edgePixelOrientIdx, brightDarkSide)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Extract L*a*b colour channel ratio features.
% 
% Input:
...
%
% Output:
%   labRatioFeat,       L*a*b ratio features
%
% ----------------
% Aleksandrs Ecins
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i=1:numel(scales)
    ...
    labRatioFeat.(scaleNames{i}) = zeros(numEdgePixels, 3);
end

%% Preprocess image
C = makecform('srgb2lab');
im = applycform(im2uint8(im),C);
...
for scaleIdx = 1:numScales
    ...
    for clrChannel = 1:3
        ...
        for pixelIdx=1:numEdgePixels
            ...
            labRatioFeat.(scaleNames{scaleIdx})(pixelIdx, clrChannel) = brightClrMean / darkClrMean;
        end
    end
end